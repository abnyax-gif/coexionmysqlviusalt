...
CREATE TABLE `estudiantes` (
  ...
  KEY `fk_tipos_sangre_estudiantes_tipos_sangre_idx` (`id_tipos_sangre`),
  CONSTRAINT `fk_tipos_sangre_estudiantes_tipos_sangre` FOREIGN KEY (`id_tipos_sangre`) REFERENCES `tipos_sangre` (`id_tipos_sangre`) ON UPDATE CASCADE
...
INSERT INTO `estudiantes` VALUES (1,'E001','Jose Luis','perez Lopez','Guatemala',55555555,'1990-01-22',1);
...
-- Dump completed on 2026-05-06 13:53:03
